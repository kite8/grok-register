...
@router.get("/admin/pool-maintenance", include_in_schema=False)
async def admin_pool_maintenance():
    return _admin_page_response("admin/pages/pool-maintenance.html")
